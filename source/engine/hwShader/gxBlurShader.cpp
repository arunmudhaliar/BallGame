...
void gxBlurShader::bind()
{
}

void gxBlurShader::getUniformVars()
{
}

void gxBlurShader::updateShaderVars(float dt)
{
/*
    m_fAngle+=dt;
    //if(m_fAngle>=360.0f)
     //   m_fAngle=0.0f;
    enableProgram();
    sendUniform1f("time", m_fAngle);
    disableProgram();
 */
}

void gxBlurShader::inputShaderUniformVars(void* ptr)
{
}

void gxBlurShader::inputShaderAttribVars(void* ptr)
{
}

/*
void gxGUIShader::renderAsNormalMesh(objectBase* obj, const transformf& parentTM)
{
...
//	}
	...
	if((mesh->isBaseFlag(gxMesh::OBJF_USE_TM)))
	{
	...
	else
	{
		...
		//cUniformInput.u_modelview_m4x4=objectBase::getRenderer()->getViewMatrix()->getMatrix();
        
		//mvp_matrix_m4x4 = u_projection_m4x4 * mv_matrix_m4x4;
		//cModelViewProjectionMatrix = (*((RendererOGLES20*)m_pRenderer)->GetProjectionMatrix() * *(((RendererOGLES20*)m_pRenderer)->GetViewMatrix()));
		//cUniformInput.u_mvp_m4x4=objectBase::getRenderer()->getViewProjectionMatrix()->getMatrix();
		...
		//vector3f eyeObjectSpace = objectBase::getRenderer()->getViewMatrix()->getPosition();
		//eyeObjectSpace=(this->GetInverse() * ((RendererOGLES20*)m_pRenderer)->GetViewMatrix()->GetPos());
		//cUniformInput.u_eyedirection_v3=&eyeObjectSpace.x;
	}
...
void gxGUIShader::renderAsVBOMesh(objectBase* obj, const transformf& parentTM)
{
    gxMesh* mesh = (gxMesh*)obj;
	...
	{
        matrix4x4f cRenderMatrix = (parentTM * *mesh);
...
void gxBlurShader::renderThroughHWShader(objectBase* obj, const matrix4x4f* parentTM)
{
