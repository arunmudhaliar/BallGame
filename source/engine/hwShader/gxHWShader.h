...
//struct stCommonShaderUniformInput
//{
//	stCommonShaderUniformInput()
//	{
//		resetFlag();
//	}
//	
//	void resetFlag()
//	{
//		memset(u_flags_m4x4, 0, sizeof(float)*16);
//		u_modelview_m4x4=NULL;
//		u_mvp_m4x4=NULL;
//	}
//
//	const float* u_modelview_m4x4;
//	const float* u_mvp_m4x4;
//	float* u_eyedirection_v3;
//	float u_flags_m4x4[16];
//};
//
//struct stCommonShaderAttribInput
//{
//	float* a_diffuse_v3;
//	float* a_ambient_v3;
//	float* a_specular_v3;
//	float* a_shininess_f1;
//};
...
class gxHWShader : public gxShader
{
public:
	...
	virtual void renderThroughHWShader(objectBase* obj, const matrix4x4f* parentTM)=0;
...
private:
	...
	bxLinkedList<stUniformLocation*> m_vUniformRefVarList;
	bxLinkedList<stAttribLocation*> m_vAttribRefVarList;
