...
void gxGUIShader::bind()
{
}

void gxGUIShader::getUniformVars()
{
}

void gxGUIShader::updateShaderVars(float dt)
{
/*
    m_fAngle+=dt;
    //if(m_fAngle>=360.0f)
...
void gxGUIShader::inputShaderUniformVars(void* ptr)
{
}

void gxGUIShader::inputShaderAttribVars(void* ptr)
{
}
...
void gxGUIShader::renderThroughHWShader(objectBase* obj, const matrix4x4f* parentTM)
{
