...
gxDiffuseMapLightMap::gxDiffuseMapLightMap():
gxHWShader()
{
...
void gxDiffuseMapLightMap::bind()
{
}

void gxDiffuseMapLightMap::getUniformVars()
{
}

void gxDiffuseMapLightMap::updateShaderVars(float dt)
{
}

void gxDiffuseMapLightMap::inputShaderUniformVars(void* ptr)
{
}

void gxDiffuseMapLightMap::inputShaderAttribVars(void* ptr)
{
}

void gxDiffuseMapLightMap::renderThroughHWShader(objectBase* obj, const matrix4x4f* parentTM)
{
	...
	for(int y=0;y<mesh->getSubTriListCount();y++)
	{
		...
		if(subTriLst->m_iMatID>=0)
		{
            ...
            if(lightmap_uv)
            {
                ...
                {
                    shader->sendUniform1i("u_lightmap_texture", 0);
			...
			if(mat->getSubMaterialMap(gxSubMaterialMap::EMMAP_DIFFUSE))
			{
                ...
                {
                    shader->sendUniform1i("u_diffuse_texture", 1);
