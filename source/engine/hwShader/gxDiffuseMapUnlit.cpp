...
gxDiffuseMapUnlit::gxDiffuseMapUnlit():
gxHWShader()
{
...
void gxDiffuseMapUnlit::bind()
{
}

void gxDiffuseMapUnlit::getUniformVars()
{
}

void gxDiffuseMapUnlit::updateShaderVars(float dt)
{
}

void gxDiffuseMapUnlit::inputShaderUniformVars(void* ptr)
{
}

void gxDiffuseMapUnlit::inputShaderAttribVars(void* ptr)
{
}

void gxDiffuseMapUnlit::renderAsNormalMesh(objectBase* obj, const matrix4x4f* parentTM)
{
...
void gxDiffuseMapUnlit::renderAsVBOMesh(objectBase* obj, const matrix4x4f* parentTM)
{
    gxMesh* mesh = (gxMesh*)obj;
...
void gxDiffuseMapUnlit::renderThroughHWShader(objectBase* obj, const matrix4x4f* parentTM)
{
