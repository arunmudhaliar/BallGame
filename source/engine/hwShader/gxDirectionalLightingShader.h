...
#ifndef GEAR5_gxDirectionalLightingShader_h
#define GEAR5_gxDirectionalLightingShader_h


#include "gxHWShader.h"

class gxDirectionalLightingShader : public gxHWShader
{
public:
	gxDirectionalLightingShader();
	~gxDirectionalLightingShader();
